  ...
  return (
    <div className="w-full min-h-screen bg-surface px-6 md:px-12 py-24 flex flex-col md:flex-row items-center justify-center gap-12 border-t border-background md:border-none">
      <div className="flex-1 max-w-xl">
        <span className="font-mono text-amber text-lg md:text-xl block mb-4">02 / IT UNDERSTANDS</span>
      ...
      <div className="flex-1 w-full flex justify-center">
        ...
        <div className="w-full max-w-md aspect-square rounded-2xl border border-amber/30 bg-amber/5 flex items-center justify-center">
          <span className="font-mono text-amber/50">Split UI Mockup Visual</span>
        </div>
      </div>
    </div>
  );
