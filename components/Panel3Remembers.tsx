export default function Panel3Remembers() {
  return (
    <div className="w-full bg-surface px-6 md:px-12 py-32 md:py-40 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20 border-t border-background md:border-none">
      ...
      <div className="flex-1 w-full flex justify-center">
        ...
        <div className="w-full max-w-lg lg:max-w-xl aspect-square rounded-2xl border border-pureWhite/30 bg-pureWhite/5 flex items-center justify-center">
